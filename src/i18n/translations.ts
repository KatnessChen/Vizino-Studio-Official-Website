...
export const ui = {
  en: {
    ...
    'intake.mail.lead': "Already have a report? Skip the questions — just email it to us and we'll build your schedule from it.",
    'intake.mail.note': 'Send your report (PDF, JPG or PNG) to:',
    'intake.submit.email': 'Email my report',
    'intake.mail.success.title': 'Almost done!',
    'intake.mail.success.body': "We'll reply within 10 business days.",
    ...
    'intake.visit.note': 'Email us to arrange your in-home visit:',
    ...
    'intake.visit.success.body': "We'll be in touch to arrange a time.",
    ...
    'intake.success.body': "We'll email your personalized smart schedule within 10 business days.",
  },
  ...
  'zh-tw': {
    ...
    'intake.visit.success.body': '我們會回覆與你約時間。',
